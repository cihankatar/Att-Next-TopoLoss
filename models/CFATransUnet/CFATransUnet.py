...
import math
from models.CFATransUnet.CCFT import CCFT
from models.CFATransUnet.CCFA import CCFA
...
def CFATransUnet(pretrained=False,num_classes=1,**kwargs):
...
if __name__ == '__main__':
    ...
    net = CFATransUnet(pretrained=False,num_classes=1)
