...
from models.BDFormer.MaxViT.lib.helpers import build_model_with_cfg, checkpoint_seq, named_apply
from models.BDFormer.MaxViT.lib.fx_features import register_notrace_function
from models.BDFormer.MaxViT.lib.layers import Mlp, ConvMlp, DropPath, ClassifierHead, trunc_normal_tf_, LayerNorm2d, LayerNorm
from models.BDFormer.MaxViT.lib.layers import create_attn, get_act_layer, get_norm_layer, get_norm_act_layer, create_conv2d
from models.BDFormer.MaxViT.lib.layers import to_2tuple, extend_tuple, make_divisible, _assert
from models.BDFormer.MaxViT.lib.registry import register_model
from models.BDFormer.MaxViT.lib.vision_transformer_relpos import RelPosMlp, RelPosBias  # FIXME move these to common location
...
class PartitionAttentionCl(nn.Module):
    ...
    def _partition_attn(self, x):
        ...
        # print(f'after partition, partition.shape={partitioned.shape}')
...
class MaxxVit(nn.Module):
    ...
    def __init__(
        ...
        # print(f"window_size = {transformer_cfg}")
...
def _create_maxxvit(variant, cfg_variant=None, pretrained=False, **kwargs):
    # print(f'model_cfgs={model_cfgs[variant]}') if not cfg_variant else print(f'model_cfgs={model_cfgs[cfg_variant]}')
